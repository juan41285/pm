...
test('guardar tarea', async t => {
  let db = t.context.db

  t.is(typeof db.guardaTarea, 'function', 'guardaTarea is a function')

  let tarea = fixtures.getTarea()

  let created = await db.guardaTarea(tarea)
  t.is(created.desc, tarea.desc)
  t.is(created.userId, tarea.userId)
